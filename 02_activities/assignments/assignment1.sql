...
SELECT vendor_id, count(booth_number) as number_of_booth_assignments
...
customer_last_name
,customer_first_name
,CAST (sum(quantity*cost_to_customer_per_qty) as REAL) as total_spend
FROM customer c
